...
.. figure:: /_static/tiny_toasters.png
    :align: center
...
def main():
    class Toast:
        ...
        def clear(self):
            ...
            tft.fill_rect(
                self.col, self.row - 1, self.width, self.dir_row + 1, gc9a01.BLACK
            )
        ...
        def erase(self):
            ...
            tft.fill_rect(
                self.last_col, self.last_row, self.width, self.height, gc9a01.BLACK
            )
