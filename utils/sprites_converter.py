...
def convert_image_to_bitmap(image_file, bits, sprite_width, sprite_height, swap_bytes=True):
    """
...
def main():
    ...
    convert_image_to_bitmap(
        args.image_file, args.bits_per_pixel, args.sprite_width, args.sprite_height, args.swap
    )
